...
namespace SoundCheck_V1.TemplateANC
{
    ...
    public class INIClass
    {
        ...
        public static string GetValue(string section, string key, string refVar, string _path)
        {

            StringBuilder var = new StringBuilder(512);
            int length = GetPrivateProfileString(section, key, refVar, var, 512, _path);
            SetValue(section, key, var.ToString(), _path);
