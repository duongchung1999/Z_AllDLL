...
namespace MerryDllFramework
{
    public class MerryDll : IMerryAllDll
    {
        ...
        public string[] GetDllInfo()
        {
            ...
            string dllHistoryVersion7 = "                     ：22.3.14.0";
            string dllHistoryVersion8 = "                     ：23.02.13.1";
            ...
            string dllChangeInfo8 = "23.02.13.1：测试数据不上转数据库，增加测试多长时间的信息";

            string[] info = { dllname,
                dllfunction,
                dllHistoryVersion,dllHistoryVersion2,dllHistoryVersion3,dllHistoryVersion4,dllHistoryVersion5,dllHistoryVersion6,dllHistoryVersion7,dllHistoryVersion8,
                dllVersion,
                dllChangeInfo,
            dllChangeInfo2,dllChangeInfo3,dllChangeInfo4,dllChangeInfo5,dllChangeInfo6,dllChangeInfo7,dllChangeInfo8
            };
            return info;
        }
...
WHERE a1.model_id=a2.id  AND a2.`name`='{TypeName}'";
        ...
        public string SaveTestData()
        {
            try
            {
                ...
                //bool TestLogUploadMySQL = (bool)keys["TestLogUploadMySQL"] || ((int)keys["MesFlag"]) > 0;//MECH SQL
                bool TestLogUploadMySQL = false;//MEVN SQL
                ...
                #endregion   
                Console.WriteLine($"生成Logi数据：{sp.ElapsedMilliseconds}");
                ...
                #endregion
                Console.WriteLine($"上传数据：{sp.ElapsedMilliseconds}");
                ...
                #endregion
                Console.WriteLine($"本地：{sp.ElapsedMilliseconds}");
        ...
        void SaveTestData_Csv(ListView view, string SN, bool TestFlag)
        {
            ...
            name += "Time";
            string info = SN + "," + DateTime.Now.ToString("hh:mm:ss") + "," + TestFlag + "," + result+ TestTime + "s"; //增加测试多长时间的信息（TestTime）
            //Log文件不存在则创建
