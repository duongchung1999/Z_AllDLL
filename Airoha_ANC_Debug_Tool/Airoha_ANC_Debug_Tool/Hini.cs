...
namespace Airoha_ANC_Debug_Tool
{
    internal class Hini
    {
        ...
        public static string GetValue(string section, string key, string _path= @".\Debug_Tool.ini")
        {
        ...
        public static long SetValue(string section, string Key, string value, string _path = @".\Debug_Tool.ini")
        {
        ...
        public static string[] INIGetAllSectionNames(string iniFile = @".\Debug_Tool.ini")
        {
        ...
        public static string[] INIGetAllItems( string section, string iniFile = @".\Debug_Tool.ini")
        {
