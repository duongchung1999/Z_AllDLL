...
namespace MerryDllFramework
{
    public class MerryDll : IMerryAllDll
    {
        ...
        public string Run(object[] Command)
        {
            ...
            {
                default: return $"Command {cmd[1]}  // A Or mA False";
                case "a": cmd[2] = "1"; break;
                case "ma": cmd[2] = "2"; break;

            }
            return ReadDM5D(cmd[1], cmd[2]);
        }
        public string ReadDM5D(string NamePort, string id)
        {
            try
            {
                ...
                switch (id)
                {
                    ...
                    case "1": dou = double.Parse(Value) * 1000; break;
                    case "2": dou = double.Parse(Value) * 1000 ; break;
                }
                return Math.Round(dou, 2).ToString();
