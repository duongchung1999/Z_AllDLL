...
namespace VISAInstrument.Port
{
    ...
    {
        public GPIBPortOperator(string address) : base(new GpibSession(address, AccessModes.None, 5000), address)
        {
    ...
    public class PortOperatorBase : IPortOperator
    {
        ...
        {
            var i = (int)Session.ReadStatusByte();
            if (i <= 0) return "";
